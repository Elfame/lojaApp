...
class Section  extends ChangeNotifier{
  ...
  DocumentReference get firestoreRef => firestore.document('home/$id');// referencia para atualizar a seção
  ...
  Future<void>save(int pos)async{
    // função para salvar as telas da home
