...
class UserManager extends ChangeNotifier {
  ...
  Future<void> signIn({User user, Function onFail, Function onSuccess }) async{
    // recebe os dados do suer
    loading = true;
    try {
      // caso o login funcione o codigo para antes de catch
  ...
  Future<void> sigUp({User user, Function onFail, Function onSuccess}) async {
    loading = true;
    try {
  ...
  void signOut(){// sair de sua conta
    auth.signOut();
    user = null;
    notifyListeners();
