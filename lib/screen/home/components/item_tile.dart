...
// tela com alerte diolog pressionar e ter opções para excluir, disvincular e vincular
                    ...
                    onPressed: () async {
                      if(product != null){
                        item.product = null;
                         ...
                         final Product product = await Navigator.
                         of(context).pushNamed('/select_product') as Product;
